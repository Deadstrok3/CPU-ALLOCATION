...
public class CustomTuple implements Comparable{
	...
	public String toString() {
		return "{" + "serverRegion='" + serverRegion + '\'' + ", cost='" + cost + '\'' + ", servers=" + servers + "}\n";
	}

	@Override
	public int compareTo(Object customTuple) {
		// TODO Auto-generated method stub
		double comparePrice = (double)((CustomTuple) customTuple).getCost();
		return (int) (this.getCost()-comparePrice);
	}
}
